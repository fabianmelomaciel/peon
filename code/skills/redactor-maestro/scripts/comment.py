"""Add comments to Redactor Maestro documents.
...
if __name__ == "__main__":
    p = argparse.ArgumentParser(description="Add comments to Redactor Maestro documents")
    p.add_argument("unpacked_dir", help="Unpacked Redactor Maestro directory")
